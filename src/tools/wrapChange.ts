...
`;
    ...
    '',
    '**Your feature flag MUST be runtime controllable:**',
    '- ✅ **DO**: Place flag checks INSIDE handlers, functions, and execution paths',
    '- ❌ **NEVER**: Wrap route registrations, middleware mounting, or job scheduling',
    '',
    '**Why:** Runtime controllable flags can be toggled instantly without redeployment.',
    'Non-runtime controllable flags require a redeploy, defeating the purpose of feature flags.',
    '',
